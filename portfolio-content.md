# Suram Sathwik Reddy — Portfolio Content (Résumé-Verified)

## About Me / Summary

Undergraduate in Computer Science with hands-on experience building full‑stack web applications and backend systems. Strong focus on algorithmic problem solving and delivering production-ready features. Experience includes internships in web development and Python tooling; recent work includes a Virtual Classroom System and Grampower (village electricity monitoring).
...
- Jawaharlal Nehru Technological University — Bachelor of Technology in Computer Science
  - CGPA: 8.57
- SR Junior College — Intermediate
  - Percentage: 98.3%
...
- Résumé (PDF in repo): `sathwuu.pdf`


---

Notes:
- Content above contains only information verified from the résumé and the repository files.
- If you want this converted to a `README.md` or injected into `index.html` as textual content blocks, tell me and I will proceed.
